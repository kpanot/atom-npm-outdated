...
export default {
  ...
  activate() {
    ...
    this.npmWorker = new NpmWorker(this.linter, this.suggester);
    ...
    this.subscriptions.add(
      atom.config.observe('atom-npm-outdated.useCaret', (useCaret) => this.suggester.useCaret = useCaret)
    );
  },
